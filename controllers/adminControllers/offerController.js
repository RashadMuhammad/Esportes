  ...
  try {
    ...
    if (minProductPrice < 0) {
      return res.render("admin/offers", {
        ...
        products,
        categories,
        message: "Minimum product price cannot be negative.",
      });
    }
      ...
      if (discountType === "fixed") {
        if (discountValue > product.price) {
          return res.render("admin/offers", {
            ...
            products,
            categories,
            message: "Discount value cannot be greater than product price.",
          });
        }
      ...
      if (discountType === "fixed") {
        if (minProductPrice <= discountValue) {
          return res.render("admin/offers", {
            ...
            categories,
            message:
              "Minimum product price must be greater than discount value.",
          });
        }
      } else if (discountType === "percentage") {
        if (discountValue > 80) {
